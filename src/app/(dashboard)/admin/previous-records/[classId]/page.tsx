...
const ClassPreviousRecordsPage = async ({ params }: PageProps) => {
  ...
  if (!classData) {
    redirect("/admin/previous-records");
  }

  // Get all exam results for students in this class (only Grade 9 and 10 exams)
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Grade {classData.grade.level} • {classData.students.length} Students • Historical Records (Grade 9 & 10 only)
          </p>
        </div>
        <Link
...
export default ClassPreviousRecordsPage;
