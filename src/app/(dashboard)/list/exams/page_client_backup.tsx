...
const ExamListPage = () => {
  ...
  const fetchGrades = async () => {
    try {
      ...
      if (response.ok) {
        const data = await response.json();
        // The API returns { grades: [...] }, so we need data.grades
                ...
                <tr key={exam.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <Link
                        href={`/list/exams/${exam.id}/workflow-simple`}
                      ...
                      <Link
                        href={`/list/exams/${exam.id}/marks-entry-simple`}
                        className="p-2 rounded-full bg-indigo-200 hover:bg-indigo-300"
                        title="Marks Entry"
                      >
