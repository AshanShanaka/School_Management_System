...
const day = today.getDate(); // Today's date
...
export const calendarEvents = [
  {
    ...
    end: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 9, 0),
    end: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 10, 0),
    end: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 11, 0),
    end: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 13, 0),
    end: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 14, 0),
    end: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 14, 45),
  },
];
