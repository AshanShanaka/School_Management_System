...
const TimetableCreationForm: React.FC<TimetableCreationFormProps> = ({
  ...
  const periods = [1, 2, 3, 4, 5, 6, 7, 8]; // All 8 periods with interval after 4th
                      ...
                      <React.Fragment key={period}>
                        ...
                        {period === 4 && (
                          <tr className="bg-orange-50 border-t-2 border-orange-200">
                            <td colSpan={6} className="border border-gray-200 px-3 py-2 text-center">
                              <div className="flex items-center justify-center gap-2 text-orange-600 font-semibold">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                                </svg>
                                <span className="text-sm">INTERVAL BREAK (10:30 - 10:45)</span>
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                                </svg>
                              </div>
