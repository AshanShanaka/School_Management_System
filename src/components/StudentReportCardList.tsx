...
const StudentReportCardList: React.FC = () => {
  ...
  const fetchReportCards = async () => {
    try {
      setLoading(true);
      const response = await fetch("/api/student/report-cards");
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-6 rounded-xl shadow-lg text-white">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">My Report Cards</h1>
            <p className="text-indigo-100">
              View your academic performance and achievements
            </p>
          </div>
          <div className="bg-white/20 backdrop-blur-sm rounded-lg px-6 py-4">
            <div className="text-sm text-indigo-100">Total Report Cards</div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-gray-900">
                  {(
                    reportCards.reduce(
                      (sum, card) => sum + (card.percentage || 0),
                      0
                    ) / reportCards.length
                  ).toFixed(1)}
                  %
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-gray-900">
                  #{Math.min(...reportCards.map((card) => card.classRank || 999))}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-gray-900">
                  {reportCards.filter((card) => card.overallGrade === "A").length}
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-bold text-gray-900">Your Report Cards</h2>
          ...
          {reportCards.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-gray-600">
                Your report cards will appear here once your teachers generate them.
              </p>
            </div>
          ) : (
            <div className="grid gap-4">
              {reportCards.map((card) => (
                <div
                  ...
                  onClick={() => handleViewDetails(card.examId)}
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="ml-6">
                      <button className="px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors flex items-center gap-2 font-semibold">
                        <svg
                          className="w-5 h-5"
                          fill="none"
                          stroke="currentColor"
